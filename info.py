...
# Bot information
SESSION = environ.get('SESSION', 'GMFileStore')
API_ID = int(environ.get('API_ID', '34941698'))
API_HASH = environ.get('API_HASH', '7b2940bab3ebb175e9ceef78846c090b')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7859995064').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '7859995064').split()]  # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002533229703').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002612579654') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sahebchoudhury067:CElXPsYmo4XnJDQO@cluster0.crhcvk3.mongodb.net/?retryWrites=true&w=majority")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "gmfileprovider")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'gmcollection')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'gradiate_request') # Support Chat Link Without https:// or @
